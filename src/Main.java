        ...
        while (continuar){
            ...
            switch (opcao) {
                case "1":
                    ...
                    break;
                case "2":
                    if (validarLogin(usuario, scanner, usuarioDAO, cc)) {
                        menuOperacoes(usuario, cc, cp, scanner);
                    }
                    break;
                case "0":
                    continuar = false;
...
public static void cadastrarUsuario(Usuario u, Scanner s, UsuarioDAO usuarioDAO, ContaCorrente cc, ContaDAO cDAO, Random random){
        ...
        System.out.print("Número da sua conta: " + cc.getNumeroConta());
    }

public static boolean validarLogin(Usuario u, Scanner s, UsuarioDAO uD, ContaCorrente cc){
        try {
...
public static void menuOperacoes(Usuario usuario, ContaCorrente cc, ContaPoupanca cp, Scanner s) {
    boolean continuar = true;
    while (continuar) {
        System.out.println("""
